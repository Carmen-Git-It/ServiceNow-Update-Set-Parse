...
for update in root.findall('.//sys_update_xml'):
    ...
    try:
        ...
        if type == 'Choice list':
            choices = inner_root.find('.//sys_choice')
            for choice in choices:
                label = choice.findtext('.//label')
        ...
        elements[sys_id] = [type or 'None', action or 'None', table or 'None', name or 'None', display_name or 'None', sys_id or 'None', scope or 'None', updated_by or 'None', updated or 'None', internal_type or 'None', choice_list or 'None']
...
with open('output.csv', 'w') as f:
    ...
    f.write('Type,Action,Table,Name,Display Name,Sys ID,Scope,Updated By, Updated On, Internal Type, Choice List\n')
    for el in elements:
